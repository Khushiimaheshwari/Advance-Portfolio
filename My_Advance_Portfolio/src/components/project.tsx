...
const PROJECTS: ProjectType[] = [
  {
    ...
    details: [
      "Developed a full-stack laboratory management platform using Next.js, MongoDB, and NextAuth.js with QR/Barcode based asset tracking, issue reporting, and role-based workflows.",
      "Designed secure dashboards and REST API workflows for Admin, Faculty, and Technician operations with centralized authentication and inventory management.",
      "Optimized database interactions and scheduling workflows to improve operational efficiency and asset handling across laboratory systems."
    ],
    links: {
